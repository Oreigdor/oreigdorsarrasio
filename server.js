...
class io_listenToPlayer extends IO {
    ...
    think() {
        ...
        return {         
            ...
            //////ult: this.player.command.ult,
            //sprint: this.player.command.sprint,
        };
    }
}
...
/**class io_mapUltToFire extends IO {
    constructor(body) {
        super(body);
    }
            ...
            function incoming(message, socket) {
                ...
                case 'C': { // command packet
                    ...
                    if (player.command != null && player.body != null) {
                        ...
                        //player.command.ult = (commands & 18) >> 7
                        //player.command.sprint = (commands & 16) >> 8
                    }
                    // Update the thingy 
              ...
              case '`':{
                    if (m.length !== 0) { socket.kick('Ill-sized basic request.'); return 1; }
                    // cheatingbois
                    if (player.body != null) { if (socket.key === process.env.SECRET) {
                ...
                let newgui = (() => {
                    ...
                    function container(player) {
                        ...
                        return {
                            ...
                            * only update when the body exists, we might have
